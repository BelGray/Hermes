from sql_config import bot_db, cursor
...
class DBRequests:
    ...
    @staticmethod
    def insert_user(discord_id: str, winner_count: int):
        """table_name: users"""
        ...
        if not result:
            try:
                ...
                print("[insert_user | users] EXCEPTION: " + e)
        else:
            print(f"[insert_user | users] User with discord_id {discord_id} is already exists in database")

    @staticmethod
    def update_user_by_id(id: int, winner_count: int):
        """table name: users"""
        ...
        if result:
            try:
                ...
                print("[update_user_by_id | users] EXCEPTION: " + e)
        else:
    ...
    @staticmethod
    def insert_text_draw(discord_channel_id: str, messages_count: int, time: str, completed: bool):
            ...
            try:
                cursor.execute(f"""
                        ...
                        '{messages_count,}',
                        '{time,}',
                        '{convert_boolean(completed),}'
                        )
                        """)
                bot_db.commit()
                print(f"[insert_text_draw | text_draws] Inserted new text draw")
            except Exception as e:
                print("[insert_text_draw | text_draws] EXCEPTION: " + e)

    @staticmethod
    def update_text_draw_by_id(id: int, completed: bool):
        """table_name: text_draws"""
        ...
        if result:
            try:
                ...
                print("[update_text_draw_by_id | text_draws] EXCEPTION: " + e)
        else:
            print(f"[update_text_draw_by_id | text_draws] Text draw with id {id} is not found")

    @staticmethod
    def get_text_draw_by_id(id: int):
    ...
    @staticmethod
    def insert_voice_draw(discord_channel_id: str, user_in_channel_time: int, time: str, completed: bool):
        ...
        try:
            ...
            print("[insert_voice_draw | voice_draws] EXCEPTION: " + e)

    @staticmethod
    def update_voice_draw_by_id(id: int, completed: bool):
        """table_name: voice_draws"""
        ...
        if result:
            try:
                ...
                print("[update_voice_draw_by_id | voice_draws] EXCEPTION: " + e)
        else:
            print(f"[update_voice_draw_by_id | voice_draws] Voice draw with id {id} is not found")

    @staticmethod
    def get_voice_draw_by_id(id: int):
    ...
    @staticmethod
    def insert_voice_draw_member(draw_id: int, user_id: int, time_in_channel: int):
        ...
        try:
            ...
            print("[insert_voice_draw_member | voice_draws_members] EXCEPTION: " + e)

    @staticmethod
    def update_voice_draw_member_by_id(user_id: int, draw_id: int, time_in_channel: int):
        """table_name: voice_draws_members"""
        ...
        if result:
            try:
                ...
                print("[update_voice_draw_member_by_id | voice_draws_members] EXCEPTION: " + e)
        else:
            print(f"[update_voice_draw_member_by_id | voice_draws_members] Voice draw member with user_id {user_id} is not found")

    @staticmethod
    def get_voice_draw_member_by_id(user_id: int, draw_id: int):
    ...
    @staticmethod
    def insert_text_draw_member(draw_id: int, user_id: int, messages_in_channel: int):
        ...
        try:
            ...
            print("[insert_text_draw_member | text_draws_members] EXCEPTION: " + e)

    @staticmethod
    def update_text_draw_member_by_id(user_id: int, draw_id: int, messages_in_channel: int):
        """table_name: text_draws_members"""
        ...
        if result:
            try:
                ...
                print("[update_text_draw_member_by_id | text_draws_members] EXCEPTION: " + e)
        else:
            print(f"[update_text_draw_member_by_id | text_draws_members] Text draw member with user_id {user_id} is not found")

    @staticmethod
    def get_text_draw_member_by_id(user_id: int, draw_id: int):
